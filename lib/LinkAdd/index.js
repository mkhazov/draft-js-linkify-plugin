...
var _getRelativeParent = require('../utils/getRelativeParent');

var _getRelativeParent2 = _interopRequireDefault(_getRelativeParent);

var _getEntityForSelection = require('../utils/getEntityForSelection');

var _getEntityForSelection2 = _interopRequireDefault(_getEntityForSelection);
  ...
  function LinkAdd() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LinkAdd.__proto__ || Object.getPrototypeOf(LinkAdd)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (toolbarElement.style.top !== '') {
        ...
        var relativeParent = (0, _getRelativeParent2.default)(toolbarElement.parentElement);
      ...
      if (!_this.state.open) {
        var entity = (0, _getEntityForSelection2.default)(_this.props.editorState);
        var url = '';
