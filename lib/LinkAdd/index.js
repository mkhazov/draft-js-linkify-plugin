...
var LinkAdd = function (_Component) {
  ...
  function LinkAdd() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LinkAdd.__proto__ || Object.getPrototypeOf(LinkAdd)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      onChange((0, _addLink2.default)(editorState));
      _this.closePopover();
  ...
  _createClass(LinkAdd, [{
    ...
    value: function render() {
      ...
      if (this.props.showAddButton && this.props.showCloseButton) {
        // 2 buttons
        inputWidth = '78%';
      } else if (!this.props.showAddButton && !this.props.showCloseButton) {
        // no buttons
        inputWidth = '100%';
      } else {
        // 1 button
